--CUSTOM SETUPS v1.9.5
  ...
  function LaunchApp()
    ...
    if result then
      ...
      elseif version ~= TABLE_VERSION then
        ...
        UDF1.Caption="Custom Setups | Online v1.9.5"
  ...
  function SetCustomClassesArrays()
    ...
    DRIFTarray = Set {'ELEGY','EUROS','RT3000','VECTRE','JESTER4','SCHWARZE','COMET3','ZR350','ELEGY2','REMUS','NEON','TENF2','R300'}
  end
  ...
  function LoadChassisSettings()
    ...
    function ApplyDRIFTMod(IntoDRIFT,FWD,RWD,Drive,MaxFlat,CurveMax,CurveMin,CurveLat,Steering,CurveLatR,LowSpeed,Mass)
